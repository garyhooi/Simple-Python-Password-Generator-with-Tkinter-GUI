...
#  May 10, 2020 01:27:26 AM CST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top43 {base} {
    ...
    wm geometry $top 600x450+422+284
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    label $top.lab44 \
        -background $vTcl(actual_gui_bg) -disabledforeground #a3a3a3 \
        -font TkDefaultFont -foreground $vTcl(actual_gui_fg) -text Length: 
    ...
    place $top.spi45 \
        -in $top -x 0 -relx 0.283 -y 0 -rely 0.444 -width 0 -relwidth 0.208 \
        -height 0 -relheight 0.042 -anchor nw -bordermode ignore 
    place $top.lab44 \
        -in $top -x 0 -relx 0.283 -y 0 -rely 0.378 -width 0 -relwidth 0.077 \
