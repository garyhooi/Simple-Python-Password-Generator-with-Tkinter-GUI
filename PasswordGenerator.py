...
#    May 09, 2020 11:41:39 PM CST  platform: Windows NT
...
class Toplevel1:
    ...
    def generatePwd(self):
        try:
            pwdLength = int(self.sb_length.get())
        except ValueError:
             messagebox.showinfo("Warning", "Invalid number of length.")
            
        alphabet = string.ascii_letters + string.digits
        password = ''.join(secrets.choice(alphabet) for i in range(pwdLength))

        self.et_pwd.delete(0, 'end')
        self.et_pwd.insert(0, password)

    def copyToClipboard(self):
        password = self.et_pwd.get()
    ...
    def __init__(self, top=None):
        ...
        self.btn_generate.place(relx=0.3, rely=0.578, height=44, width=107)
        ...
        self.btn_exit.place(relx=0.55, rely=0.578, height=44, width=107)
        ...
        self.et_pwd.place(relx=0.283, rely=0.267,height=37, relwidth=0.323)
        ...
        self.btn_copy.configure(command=self.copyToClipboard)

        self.sb_length = tk.Spinbox(top, from_=1.0, to=100.0)
        self.sb_length.place(relx=0.283, rely=0.444, relheight=0.042
                , relwidth=0.208)
        ...
        self.Label2.place(relx=0.283, rely=0.378, height=21, width=46)
